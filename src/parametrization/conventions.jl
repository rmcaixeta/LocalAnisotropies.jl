...
function rotmat(semiaxes::AbstractVector, angles::AbstractVector, convention=:TaitBryanExtr; rev=false)
  N = length(semiaxes)
...
function anisodistance(semiaxes::AbstractVector, angles::AbstractVector, convention=:TaitBryanExtr; rev=false)
